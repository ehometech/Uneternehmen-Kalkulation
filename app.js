...
function calcRow(id){let r=costRows.find(x=>x.id===id);r.amount=Math.round(safeCalc(r.calc)*100)/100;renderCostRows();calcAll()}
function addCostRow(){costRows.push({id:Date.now(),group:"lohnunabhängige GK",name:"Neue Kostenart",amount:0,calc:"",installation:100,verwaltung:0,material:0});renderCostRows();calcAll()}
...
function syncPayrollToBABAuto(updateProductiveHours=true){
 ...
 setAutoBABRow('lgSVprod',   'lohngebundene GK','SV AG-Anteil auf Fertigungslohn (produktiv)',          s.lgSVprod||s.lgSV*0.9,100,0,0);
 setAutoBABRow('lgSVunprod', 'lohngebundene GK','SV AG-Anteil auf Hilfslöhne (unproduktiv)',            s.lgSVunprod||s.lgSV*0.1,70,30,0);
 ...
 setAutoBABRow('lgOtherProd','lohngebundene GK','Sonstige gesetzl. Nebenkosten (produktiver Anteil)',   s.lgOtherProd||s.lgOther*0.9,100,0,0);
 setAutoBABRow('lgOtherUnprod','lohngebundene GK','Sonstige gesetzl. Nebenkosten (unproduktiver Anteil)',s.lgOtherUnprod||s.lgOther*0.1,70,30,0);
 setAutoBABRow('lgCompProd', 'lohngebundene GK','Betriebliche Zusatzkosten (produktiver Anteil)',       s.lgCompProd||s.lgCompany*0.9,100,0,0);
 setAutoBABRow('lgCompUnprod','lohngebundene GK','Betriebliche Zusatzkosten (unproduktiver Anteil)',    s.lgCompUnprod||s.lgCompany*0.1,70,30,0);
 // lohnunabhängige GK
